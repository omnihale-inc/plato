    ...
    <section id="history">
      <div className="flex flex-col justify-between items-center mx-auto max-w-6xl w-5/6 py-6 lg:py-8 h-fit">
        <p className="lg:text-lg text-center text-sm">
          Step into the past! Tap the button to uncover our school's incredible
        ...
        {showModal && (
          <Modal onSetModal={setShowModal} type="history">
            <div className="flex justify-between gap-4 lg:gap-10 mb-5 lg:mb-10 overflow-y-auto modal-content-scroll ">
            ...
            <div className="h-[50vh] text-center text-sm lg:text-base overflow-y-auto modal-content-scroll">
              ...
              {schoolData.history.texts.events.map((event, index) => (
                <ul className="my-5 lg:my-10" key={index}>
                  <h2 className="uppercase font-black mb-3">{event.title}</h2>
